...
df = pd.read_csv("features_processed_pchembl.csv")
...
# Save outputs
np.save("X_train_pchembl.npy", X_train)
np.save("y_train_pchembl.npy", y_train)
np.save("X_val_pchembl.npy", X_val)
np.save("y_val_pchembl.npy", y_val)
np.save("X_test_pchembl.npy", X_test)
np.save("y_test_pchembl.npy", y_test)
np.save("X_blind_pchembl.npy", X_blind)
np.save("y_blind_pchembl.npy", y_blind)
np.save("X_blind_protein_pchembl.npy", X_blind_protein)
np.save("y_blind_protein_pchembl.npy", y_blind_protein)
np.save("X_blind_ligand_pchembl.npy", X_blind_ligand)
np.save("y_blind_ligand_pchembl.npy", y_blind_ligand)
