...
df = pd.read_csv("data/processed/features_processed_pchembl.csv")
...
y_val = val_df["pchembl_value"].values
y_test = test_df["pchembl_value"].values
y_blind = df_blind["pchembl_value"].values
y_blind_protein = blind_protein["pchembl_value"].values
y_blind_ligand = blind_ligand["pchembl_value"].values
...
# Save outputs
np.save("data/models/XGBoost_pchembl/X_train_pchembl.npy", X_train)
np.save("data/models/XGBoost_pchembl/y_train_pchembl.npy", y_train)
np.save("data/models/XGBoost_pchembl/X_val_pchembl.npy", X_val)
np.save("data/models/XGBoost_pchembl/y_val_pchembl.npy", y_val)
np.save("data/models/XGBoost_pchembl/X_test_pchembl.npy", X_test)
np.save("data/models/XGBoost_pchembl/y_test_pchembl.npy", y_test)
np.save("data/models/XGBoost_pchembl/X_blind_pchembl.npy", X_blind)
np.save("data/models/XGBoost_pchembl/y_blind_pchembl.npy", y_blind)
np.save("data/models/XGBoost_pchembl/X_blind_protein_pchembl.npy", X_blind_protein)
np.save("data/models/XGBoost_pchembl/y_blind_protein_pchembl.npy", y_blind_protein)
np.save("data/models/XGBoost_pchembl/X_blind_ligand_pchembl.npy", X_blind_ligand)
np.save("data/models/XGBoost_pchembl/y_blind_ligand_pchembl.npy", y_blind_ligand)
