...
df = pd.read_csv("data/processed/features_processed_pKi.csv")
...
# Save outputs
np.save("data/models/XGBoost_pki/X_train_pki.npy", X_train)
np.save("data/models/XGBoost_pki/y_train_pki.npy", y_train)
np.save("data/models/XGBoost_pki/X_val_pki.npy", X_val)
np.save("data/models/XGBoost_pki/y_val_pki.npy", y_val)
np.save("data/models/XGBoost_pki/X_test_pki.npy", X_test)
np.save("data/models/XGBoost_pki/y_test_pki.npy", y_test)
np.save("data/models/XGBoost_pki/X_blind_pki.npy", X_blind)
np.save("data/models/XGBoost_pki/y_blind_pki.npy", y_blind)
np.save("data/models/XGBoost_pki/X_blind_protein_pki.npy", X_blind_protein)
np.save("data/models/XGBoost_pki/y_blind_protein_pki.npy", y_blind_protein)
np.save("data/models/XGBoost_pki/X_blind_ligand_pki.npy", X_blind_ligand)
np.save("data/models/XGBoost_pki/y_blind_ligand_pki.npy", y_blind_ligand)
