...
# Load datasets
X_train = np.load("data/models/DNN_pki/X_train_pki.npy")
y_train = (np.load("data/models/DNN_pki/y_train_pki.npy") >= 6.5).astype(int)
X_val = np.load("data/models/DNN_pki/X_val_pki.npy")
y_val = (np.load("data/models/DNN_pki/y_val_pki.npy") >= 6.5).astype(int)
X_test = np.load("data/models/DNN_pki/X_test_pki.npy")
y_test = (np.load("data/models/DNN_pki/y_test_pki.npy") >= 6.5).astype(int)
X_blind = np.load("data/models/DNN_pki/X_blind_pki.npy")
y_blind = (np.load("data/models/DNN_pki/y_blind_pki.npy") >= 6.5).astype(int)
X_blind_protein = np.load("data/models/DNN_pki/X_blind_protein_pki.npy")
y_blind_protein = (np.load("data/models/DNN_pki/y_blind_protein_pki.npy") >= 6.5).astype(int)
X_blind_ligand = np.load("data/models/DNN_pki/X_blind_ligand_pki.npy")
y_blind_ligand = (np.load("data/models/DNN_pki/y_blind_ligand_pki.npy") >= 6.5).astype(int)

# Load best hyperparameters
with open("data/models/DNN_pki/best_DNN_hyperparams_pki_classification.json", "r") as f:
...
well_predicted_df.to_csv("data/models/DNN_pki/well_predicted_blind_features.csv", index=False)
print(f"\nSaved {len(well_predicted_df)} well-predicted examples to 'data/models/DNN_pki/well_predicted_blind_features.csv'.")