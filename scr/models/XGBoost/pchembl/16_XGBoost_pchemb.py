...
y_train_reg = np.load("data/models/XGBoost_pchembl/y_train_pchembl.npy")
X_val = np.load("data/models/XGBoost_pchembl/X_val_pchembl.npy")
y_val_reg = np.load("data/models/XGBoost_pchembl/y_val_pchembl.npy")
...
import json
with open("data/models/XGBoost_pchembl/best_xgboost_hyperparams_pchembl_classification.json", "w") as f:
